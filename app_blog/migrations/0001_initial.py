# Generated by Django 5.0.2 on 2024-11-12 07:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_blog.category')),
            ],
        ),
        migrations.CreateModel(
            name='Blog',
            fields=[
                ...
                ('tags', models.ManyToManyField(to='app_blog.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_blog.comment')),
            ],
        ),
    ]
